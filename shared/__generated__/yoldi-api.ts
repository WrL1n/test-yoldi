...
export class Api<SecurityDataType extends unknown> {
  ...
  api = {
     ...
     * @response `201` `ApiKeyDto`
     */
    login: (data: LoginDto, params: RequestParams = {}) =>
      this.http.request<ApiKeyDto, any>({
        path: `/api/auth/login`,
        method: "POST",
        body: data,
    ...
    myProfile: (params: RequestParams = {}) =>
      this.http.request<ProfileDto, any>({
        path: `/api/profile`,
        method: "GET",
        secure: true,
        format: "json",
     ...
     * @tags User
     * @name User
     * @request GET:/api/user/{slug}
     * @response `200` `ProfileDto`
     */
    user: (slug: string, params: RequestParams = {}) =>
      this.http.request<ProfileDto, any>({
        path: `/api/user/${slug}`,
        method: "GET",
        format: "json",
    ...
    uploadImage: (data: UploadImagePayload, params: RequestParams = {}) =>
      this.http.request<ImageDto, any>({
        path: `/api/image`,
        method: "POST",
        body: data,
